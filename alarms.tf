...
resource "aws_cloudwatch_metric_alarm" "ApproximateNumberOfMessagesVisible" {
  ...
  alarm_name          = "${var.alarm_prefix}: ${var.sqs_name} Approximate Number Of Messages Visible is high for ${var.sqs_name}"
  comparison_operator = "GreaterThanOrEqualToThreshold"
...
resource "aws_cloudwatch_metric_alarm" "ApproximateAgeOfOldestMessage" {
  ...
  alarm_name          = "${var.alarm_prefix}: ${var.sqs_name} Approximate Age Of Oldest Message is high for ${var.sqs_name}"
  comparison_operator = "GreaterThanOrEqualToThreshold"
