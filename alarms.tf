resource "aws_cloudwatch_metric_alarm" "ApproximateNumberOfMessagesNotVisible" {
  ...
  alarm_name          = "${var.alarm_prefix}: ${var.sqs_name} Approximate Number Of Messages Not Visible is high"
...
resource "aws_cloudwatch_metric_alarm" "ApproximateNumberOfMessagesVisible" {
  ...
  alarm_name          = "${var.alarm_prefix}: ${var.sqs_name} Approximate Number Of Messages Visible is high"
  comparison_operator = "GreaterThanOrEqualToThreshold"
...
resource "aws_cloudwatch_metric_alarm" "ApproximateAgeOfOldestMessage" {
  ...
  alarm_name          = "${var.alarm_prefix}: ${var.sqs_name} Approximate Age Of Oldest Message is high"
  comparison_operator = "GreaterThanOrEqualToThreshold"
